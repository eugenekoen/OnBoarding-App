            ...
            {steps.map((step, index) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col sm:flex-row items-center gap-2 group transition-all text-left outline-none ${index === steps.length - 1 ? 'flex-1 justify-end' : 'flex-1'
                    }`}
                >
                  <div className="flex items-center w-full">
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-xs border transition-all ${isActive
                  ...
                  <div className="mt-1 sm:mt-0 text-center sm:text-left">
                    <span
                      className={`text-[10px] sm:text-[11px] font-bold tracking-wider block uppercase ${isActive
                          ? 'text-brand'
                          : isCompleted
                            ? 'text-accent-dark'
