    ...
    <div className="space-y-5 animate-fade-in print:bg-white print:p-0 print:m-0">
      ...
      <div className="flex justify-between items-center pt-2 print:hidden">
        ...
        <button
          ...
          disabled={isSubmitting}
          className={`font-bold text-xs uppercase tracking-wider px-6 py-3 rounded-md flex items-center gap-2 transition cursor-pointer shadow-xs ${isSubmitting
